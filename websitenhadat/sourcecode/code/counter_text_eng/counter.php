...
<body style="margin:0">
<table cellpadding="0" cellspacing="0" style="border:0px solid #000000; color:#0000FF" align="center" width="100%"> 
  <tr> 
    <td ><strong>-Online :<? echo $online; ?></strong><br>
      -<strong>Hôm nay :</strong> <strong><? echo $day; ?></strong><br>
      -<strong>Tuần : <? echo $week; ?></strong><br>
      -<strong>Tháng : <? echo $month; ?></strong><br />
      -<strong>Năm : <? echo $year; ?></strong><br>
      -<strong>Tất cả : <? echo $all; ?></strong>
      <hr noshade="noshade" align="center" color="#FF0000" />
 </td>
  </tr>
</table>
</body>