...
$mxiObj->IncludeStatic("tintucngang", "tintucngang.php", "", "", "");
$mxiObj->IncludeStatic("dangki", "regestry.php", "", "", "");
$mxiObj->IncludeStatic("dangnha", "dangnha.php", "", "", "");
$mxiObj->IncludeStatic("thongtincanhan", "thongtincanhan.php", "", "", "");
$mxiObj->IncludeStatic("lienhe", "lienhe.php", "", "", "");
$mxiObj->IncludeStatic("thongke", "thongke.php", "", "", "");
$mxiObj->IncludeStatic("tintucchitiet", "tintucchitiet.php", "", "", "");
$mxiObj->IncludeStatic("yeucaunha", "yeucaunha.php", "", "", "");
$mxiObj->IncludeStatic("xemhetnha", "xemhetnha.php", "", "", "");
...
<table width="800" align="center" cellpadding="0" cellspacing="0" style="background-image:url(images_gd/nen_center.gif)">
  ...
  <tr>
    ...
    <table class="can_top_table" align="center" width="500" height="40" border="0" cellpadding="0" cellspacing="0" background="images_gd/nen_menuduoi.gif">
   		<tr>
        	<td align="center"><span class="lienket1"><a href="index.php">Trang Chủ </a></span>|&nbsp;<span class="lienket1"><a href="index_noidung.php?mod=timkiem">Tim Kiếm</a></span>&nbsp;|&nbsp;<span class="lienket1"><a href="index_tintuc.php?mod=tintucngang">Tin Tức </a></span>| <span class="lienket1"><a href="index_tintuc.php?mod=thongke">Thống Kê</a></span> | <span class="lienket1"><a href="index_tintuc.php?mod=lienhe">Liên Hệ</a></span> | <span class="lienket1"><a href="index_tintuc.php?mod=yeucaunha">Đăng Yêu Cầu Nhà</a></span></td>
        </tr>
    </table>
    <!--////////////////////////-->
    ...
    <table class="can_top_table" width="550" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
            <td width="530" background="images_gd/trai_giua.gif" style="background-repeat:repeat-y; padding-left:20px">
              <?php
...
?></td>
    ...
    <table class="can_top_table" width="220" cellpadding="0" cellspacing="0" border="0" align="center">
        	<tr>
            <td  height="30" align="center" background="images_gd/phai_tren.gif" style=" background-repeat:no-repeat"><span class="chu_tieude">Tin Tức</span></td>
            </tr>
            <tr>
